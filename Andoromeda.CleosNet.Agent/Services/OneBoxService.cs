...
namespace Andoromeda.CleosNet.Agent.Services
{
    public class OneBoxService
    {
        ...
        public Guid StartEosNode()
        {
            ...
            var startInfo = new ProcessStartInfo("/opt/eosio/bin/nodeos", $"-e -p eosio --plugin eosio::chain_api_plugin --plugin eosio::history_api_plugin --plugin eosio::http_plugin ");
